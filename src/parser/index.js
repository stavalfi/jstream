...
import parseFlowGraph from './flow-parser';
import parseStateMachineGraph from './state-machine-parser';

export const parse = workflowConfig => ({
  flows: parseFlowGraph(workflowConfig),
  stateMachine: parseStateMachineGraph(workflowConfig),
});
